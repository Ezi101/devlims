...
class ExpenseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            AuditLogger::log('created', 'Expenses', 'Expense ID: ' . $expense->id);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            event(new ExpenseCreatedOrModified($expense));
            AuditLogger::log('updated', 'Expenses', 'Expense ID: ' . $expense->id .' was updated');
    ...
    public function destroy($id)
    {
        ...
        if (request()->ajax()) {
            try {
                ...
                AuditLogger::log('deleted', 'Expenses', 'Expense ID: ' . $expense->id);
