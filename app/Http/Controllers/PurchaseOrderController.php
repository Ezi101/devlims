            ...
            return Datatables::of($purchase_orders)
                ->addColumn('action', function ($row) use ($is_admin) {
                    ...
                    if (auth()->user()->can('purchase_order.delete')) {
                        $html .= '<li><a href="'.action([\App\Http\Controllers\PurchaseOrderController::class, 'destroy'], [$row->id]).'" class="delete-receive-stock-order"><i class="fas fa-trash"></i>'.__('messages.delete').'</a></li>';
                    }
