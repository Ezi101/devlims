...
class LabelsController extends Controller
{
    ...
    public function printChemicalLabel($id)
    {
        $transaction = Transaction::where('id',$id)->pluck('product_id')->first();
        $chemical = Product::where('id', $transaction)->first();
        return view('labels.chemical_label', compact('chemical'));
    }
}
