...
class BrandController extends Controller
{
    ...
    public function create()
    {
        ...
        // Yeh line zaroori hai dropdown ke liye
        ...
        return view('brand.create')
            ->with(compact('quick_add', 'is_repair_installed', 'brands')); // 'brands' lazmi pass karein
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            AuditLogger::log('created', 'Manufacturers', 'Manufacturer ID: ' . $brand->id . ' & Name: ' . $brand->name);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (request()->ajax()) {
            try {
                ...
                $logMessage = "<b>Manufacturer ID: " . $brand->id . "</b> was <b>updated:</b><br>" . $changesDetails;
                AuditLogger::log('updated', 'Manufacturers', $logMessage);
    ...
    public function destroy($id)
    {
        ...
        if (request()->ajax()) {
            try {
                ...
                $brand = Brands::where('business_id', $business_id)->findOrFail($id);
                $brand->delete();
                AuditLogger::log('deleted', 'Brands', 'Brand ID: ' . $brand->id);
