...
class Transaction extends Model
{
    ...
    {
        return $this->hasOne(PurchaseChecklist::class);
    }
    ...
    {
        return $this->hasone(PTR::class, 'sample_id', 'product_id');
    }

    public function delivryperson()
    {
        return $this->hasOne(DeliveryPerson::class, 'id', 'delivery_person_id');
    }

    //Reltion To User For Issue TO
    ...
    {
        return $this->hasMany(Batch::class, 'id', 'batch_no');
    }

    //Relation To Source Customer
    public function source_customer()
    {
        return $this->hasOne(SourceCustomer::class, 'id', 'source_customer_id');
    }

    public function demand_by_role()
    {
        return $this->belongsTo(Role::class, 'demand_by');
    }

    public function demandByUser()
    {
        return $this->belongsTo(User::class, 'demand_by');
    }
    ...
    public function s_t_r()
    {
        return $this->hasOne(STR::class, 'sample_id', 'product_id');
    }
}
