...
class Product extends Model
{
    ...
    {
        return $this->belongsTo(\App\Section::class, 'section_id', 'id');
    }

    public static function forDropdown($business_id)
    {
        $categories = Product::where('business_id', $business_id)->pluck('name', 'id');
        return $categories;
    }
    ...
    {
        return $this->hasOne(\App\Transaction::class, 'id', 'product_id');
    }


    public function transaction()
    {
        return $this->hasOne(\App\Transaction::class, 'product_id');
    }

    public function methods()
    {
        return $this->hasMany(\App\Methods::class, 'sample_id', 'id');
    }

    public function assoc_test()
    {
        return $this->hasMany(\App\SampleAndTests::class, 'sample_id', 'id');
    }
    public function sampleReadings()
    {
        return $this->hasMany(SampleReading::class, 'product_id', 'id');
    }

    public function generic()
    {
        return $this->hasOne(GenericName::class, 'id', 'generic_name');
    }
    public function genericNames()
    {
        return $this->belongsToMany(GenericName::class, 'product_generic_name');
    }

    public function pharma()
    {
        return $this->hasOne(Pharmacopoeia::class, 'id', 'types_of_sample');
    }
    public function w_pharma()
    {
        return $this->hasOne(Pharmacopoeia::class, 'id', 'water_pharma');
    }
    public function project()
    {
        return $this->hasMany('Modules\Project\Entities\Project', 'product_id', 'id');
    }

    public static function forSampleNameSearchDropdown($business_id)
    {
        $SampleName = Product::where('business_id', $business_id)->where('product_type', 'sample')->groupBy('name')->pluck('name', 'id');
        return $SampleName;
    }

    public function method()
    {
        return $this->hasMany(Methods::class, 'ptr_id');
    }
    public function dosage()
    {
        return $this->hasOne(Dosage::class, 'id', 'dosage_form');
    }
    public function strs()
    {
        return $this->hasManyThrough(
            \App\STR::class,
            \App\Batch::class,
            'sample_id', // Foreign key on batches table
            'batch_no',   // Foreign key on strs table
    ...
    {
        return $this->hasMany(\App\Batch::class, 'sample_id');
    }
}
