        ...
        $notification_template_data = [
            ...
            [
                ...
                'email_body' => '<p>Dear {contact_name},</p>
                    ...
                    <p>We have a new order with reference number {order_ref_number}. Kindly process the samples as soon as possible.</p>

                    <p>{business_name}<br />
                    {business_logo}</p>',
                'sms_body' => 'Dear {contact_name}, We have a new order with reference number {order_ref_number}. Kindly process the samples as soon as possible. {business_name}',
