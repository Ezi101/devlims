...
class OldDummyBusinessSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::insert("INSERT INTO business_locations (id, business_id, name, country, state, 
					...
					(1, 1, 'Awesome Shop', 'USA', 'Arizona', 'Phoenix', '85001', 1, 1, 1,'browser',
        ...
        DB::insert("INSERT INTO contacts (id, business_id, type, supplier_business_name, name, 
        			tax_number, city, state, country, mobile, landline, 
        			alternate_number, pay_term_number, pay_term_type, created_by, is_default, 
        			deleted_at, created_at, updated_at) VALUES
					(1, 1, 'customer', NULL, 'Walk-In Customer', NULL, 'Phoenix', 'Arizona', 'USA',  '(378) 400-1234', NULL, NULL, NULL, NULL, 1, 1, NULL, '2018-01-04 02:15:20', '2018-01-04 02:35:37'),
					(2, 1, 'supplier', 'Alpha Clothings', 'Michael', '4590091535', 'Phoenix', 'Arizona', 
					'USA', '(378) 400-1234', NULL, NULL, 15, 'days', 1, 0, NULL, 
					'2018-01-04 02:29:38', '2018-01-04 02:35:10'),
					(3, 1, 'supplier', 'Manhattan Clothing Ltd.', 'Philip', '54869310093', 'Phoenix', 
					'Arizona', 'USA', '(378) 400-1234', NULL, NULL, 15, 'days', 1, 0, 
