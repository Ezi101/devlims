$(document).ready(function () {
    ...
    //Quick add Batch
    $(document).on('submit', 'form#quick_batch_add_form', function (e) {
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.success == true) {
                    var newOption = new Option(result.data.code, result.data.id, true, true);
                    // Append it to the select
                    $('#batch_no').append(newOption).val('').trigger('change');
    ...
    //Quick add Contract
    $(document).on('submit', 'form#quick_add_contract_form', function (e) {
        e.preventDefault();
        var form = $(this);
        var data = form.serialize();
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.success == true) {
                    var newOption = new Option(result.data.number, result.data.id, true, true);
                    // Append it to the select
                    $('#contract_no').append(newOption).val('').trigger('change');
                    $('div.view_modal').modal('hide');
                    toastr.success(result.msg);
                } else {
                    toastr.error(result.msg);
