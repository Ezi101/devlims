$(document).ready(function () {
    ...
    $(document).on('click', '#add_variation', function () {
        ...
        $.ajax({
            method: 'POST',
            url: '/samples/get_sample_variation_row',
    ...
    $('.location_add_modal, .location_edit_modal').on('shown.bs.modal', function (e) {
        ...
        $('form#business_location_add_form')
            ...
            .select2({
                ...
                placeholder: '',
                ajax: {
                    url: '/samples/list?not_for_selling=true',
                    dataType: 'json',
                    delay: 250,
...
function get_sub_categories() {
    ...
    $.ajax({
        method: 'POST',
        url: '/samples/get_sub_categories',
        dataType: 'html',
        data: { cat_id: cat },
        success: function (result) {
            if (result) {
