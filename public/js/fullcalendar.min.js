...
var FullCalendar = (function (e) {
    ...
    function O(e) {
        ...
        if (e.__k)
            for (t = e.__k.length - 1; t >= 0; t--) if ((n = e.__k[t]) && (r = O(n))) return r;
        return null;
    }
    ...
    function Ft(e) {
        return (
            ot(e.getUTCHours(), 2) + ':' + ot(e.getUTCMinutes(), 2) + ':' + ot(e.getUTCSeconds(), 2)
        );
    }
    function Vt(e, t = !1) {
        let n = e < 0 ? '-' : '+',
    ...
    class Vn extends D {
        ...
        safeSetState(e) {
            _n(this.state, Object.assign(Object.assign({}, this.state), e), this.stateEquality) ||
                this.setState(e);
        }
    }
    ...
    function fr(e, t) {
        return (
            'function' == typeof e && (e = e()), null == e ? t.createNowMarker() : t.createMarker(e)
        );
    }
    class gr {
        constructor(e) {
    ...
    function Sr(e, t, n, r, i = Dr(n), s, o) {
        ...
        let u = (function (e, t, n, r) {
            ...
            null == o &&
                (o = null != t ? t : (!i || i.isTimeUnspecified) && (!s || s.isTimeUnspecified));
            o && a && (a = Mt(a));
    ...
    function Zr(e, t) {
        ...
        return (
            Object.assign(
                ...
                ((r = e),
                (i = t.dateEnv),
                Object.assign(Object.assign({}, wi(r.range, i, r.allDay)), { allDay: r.allDay }))
            ),
            n
        );
    }
    ...
    function bi(e, t) {
        ...
        return (
            null == a &&
                ((a = n.interactive), null == a && (a = Boolean(s.hasHandlers('eventClick')))),
            a
                ? qe((e) => {
    ...
    class Ni {
        ...
        addEventSource(e) {
            ...
            let n = jr(e, t);
            return n
                ? (this.dispatch({ type: 'ADD_EVENT_SOURCES', sources: [n] }), new ei(t, n))
                : null;
        }
    ...
    class Da extends Gn {
        ...
        renderWidgetGroup(e) {
            ...
            for (let s of e) {
                ...
                if ('title' === e)
                    (i = !1),
                        r.push(p('h2', { className: 'fc-toolbar-title', id: t.titleId }, t.title));
                else {
    ...
    class Fl extends Gn {
        render() {
            ...
            return p(
                ...
                (e) =>
                    p(e, { elTag: 'div', elClasses: ['fc-timegrid-more-link-inner', 'fc-sticky'] })
            );
        }
    }
    function Vl(e) {
            ...
            let { props: n, context: r } = this,
                i = Xl(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
                    ...
                    return p(
                        ...
                        'bg-event' === t
                            ? p(go, Object.assign({ seg: s }, mi(s, n.todayRange, n.nowDate)))
                            : mo(t)
                    );
                });
            return p(y, null, i);
