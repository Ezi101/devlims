LANG = {
    'required': 'Required',
    'sure': 'Are you sure ?',
    'remove_product': 'Are you sure to remove the sample?',
    'cancel_invoice':  'Are you sure to cancel the invoice?',
    'no_products': 'No samples added',
    ...
    'sku_already_exists': 'Sample ID already exists.',
    ...
    'clear': 'Clear',
    'no_products_added': 'No Samples added, add some samples first',
    ...
    'add_name_as_new_product': 'Add ":term" as new sample',
    'no_products_found': 'No matching sample found!',
    'cancel': 'Cancel',
    'ok': 'OK',
    ...
    'tour_step2_content':'Here you can find your shop related information, Basic information, Sample ID, Discounts, Taxes & other settings.',
    ...
    'tour_step5_title': 'Step4: Manage Samples',
    ...
    'tour_step7_content': 'Sell -> POS, Use this screen while selling samples or billing customer. Select Location, Add Samples and Finalize it.',
    ...
    'label_no_product_error': 'Please, add atleast one sample.',
    ...
    'details': 'Details',
    'select_location': 'You must select location before selecting any samples.',
    'location_id_already_exists': 'Location ID already exists',
    'add_name_as_new_supplier': 'Add ":name" as new supplier',
    'all': 'All',
    'filter_by_date': 'Filter by date',
    'form_will_get_reset': 'All added samples will be removed.',
    'tour_step3_content_modified': 'Add Multiple Locations, Tax Rates, Invoice Settings for your shop.',
    'tour_step5_content_modified': 'Add Samples - Simple or Variable Samples <br> Create Variations for variable samples <br> Create Units, Brands and Categories <br> Print labels',
    ...
    'skus_already_exists': 'sample id :sample id already exists',
