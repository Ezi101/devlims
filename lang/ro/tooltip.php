...
return [
    ...
    */
    ...
    'product_stock_alert' => "Samples with low stock.<br/><small class='text-muted'>Based on sample alert quantity set in add sample screen.<br> Purchase this samples before stock ends.</small>",
    ...
    'no_of_products_for_trending_products' => 'Number of top trending samples to be compared in the chart below.',

    'top_trending_products' => "Top selling samples of your shop. <br/><small class='text-muted'>Apply filters to know trending products for specific Category, Brand, Storage Location etc.</small>",
    ...
    <br><b>Combo sample</b>: A combination of multiple samples, also called bundle sample',
    ...
    'sale_location' => 'Storage location from where you want to sell',
    ...
    'default_profit_percent' => "Default profit margin of a sample. <br><small class='text-muted'>Used to calculate selling price based on purchase price entered.<br/> You can modify this value for indivisual samples while adding</small>",
    ...
    'unit_allow_decimal' => 'Decimals allows you to sell the related samples in fractions.',

    'print_label' => 'Add samples ->Choose informations to show in Labels -> Select Barcode Setting -> Preview Labels -> Print',
