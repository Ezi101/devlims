...
return [
    ...
    */
    ...
    'product_stock_alert' => "Samples with low stock.<br/><small class='text-muted'>Based on sample alert quantity set in add sample screen.<br> Purchase this nomenclatures before stock ends.</small>",
    ...
    'no_of_products_for_trending_products' => 'Number of top trending nomenclatures to be compared in the chart below.',

    'top_trending_products' => "Top selling nomenclatures of your shop. <br/><small class='text-muted'>Apply filters to know trending nomenclatures for specific Category, Brand, Storage Location etc.</small>",

    'sku' => "Unique sample id or Stock Keeping Unit <br><br>Keep it blank to automatically generate sample id.<br><small class='text-muted'>You can modify sample id prefix in Business settings.</small>",

    'enable_stock' => "Enable or disable stock management for a sample. <br><br><small class='text-muted'>Stock Management should be disable mostly for services. Example: Hair-Cutting, Repairing, etc.</small>",

    'alert_quantity' => "Get alert when sample stock reaches or goes below the specified quantity.<br><br><small class='text-muted'>Samples with low stock will be displayed in dashboard - Sample Stock Alert section.</small>",

    'batch_no' => "Batch No For this Sample",

    'item_temperature' => "Select type of Sample Item",

    'product_type' => '<b>Single sample</b>: Sample with no variations.
    <br><b>Variable sample</b>: Sample with variations such as size, color etc.
    <br><b>Combo sample</b>: A combination of multiple nomenclatures, also called bundle sample',

    'profit_percent' => "Default profit margin for the sample. <br><small class='text-muted'>(<i>You can manage default profit margin in Business Settings.</i>)</small>",
    ...
    'order_status' => 'Samples in this purchase will be available for sale only if the <b>Order Status</b> is <b>Items Received</b>.',

    'purchase_location' => 'Storage location where the purchased sample will be available for sale.',

    'sale_location' => 'Storage location from where you want to Issue',
    ...
    'default_profit_percent' => "Default profit margin of a sample. <br><small class='text-muted'>Used to calculate selling price based on purchase price entered.<br/> You can modify this value for indivisual nomenclatures while adding</small>",
    ...
    'invoice_scheme' => "Invoice Scheme means invoice numbering format. Select the scheme to be used for this storage location<br><small class='text-muted'><i>You can add new Invoice Scheme</b> in Invoice Settings</i></small>",

    'invoice_layout' => "Invoice Layout to be used for this storage location<br><small class='text-muted'>(<i>You can add new <b>Invoice Layout</b> in <b>Invoice Settings<b></i>)</small>",
    ...
    'unit_allow_decimal' => 'Decimals allows you to sell the related nomenclatures in fractions.',

    'print_label' => 'Add nomenclatures ->Choose informations to show in Labels -> Select Barcode Setting -> Preview Labels -> Print',

    'expense_for' => 'Choose the user for which expense is related to. <i>(Optional)</i><br/><small>Example: Salary of an employee.</small>',

    'all_location_permission' => 'If <b>All Locations</b> selected this role will have permission to access all storage locations',
    ...
    'sub_sku' => 'Sample ID is optional. <br><br><small>Keep it blank to automatically generate sample id.<small>',
    ...
    'installment_number' => 'Select Number of Instalments',
    'dosage_form' => 'Dosage Form of Sample',
    'installment_total_quantity' => 'Select Instalments to autofill this field',
    'contract_date_name' => 'Add name and date using quick add button.',
    'instalment_fill' => 'Leave empty for Tender'
];
