<?php
 ...
 return [
     ...
     'sku' => "Identifiant de produit unique ou unité de gestion des stocks <br> <br> laissez-le vide pour générer automatiquement sample id. <br> <small class = 'text-muted'> Vous pouvez modifier le préfixe sample id dans les paramètres métier </small> ",
