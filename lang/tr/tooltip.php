...
return [
    ...
    */
    ...
    'sku' => "Benzersiz ürün kimliği veya Stok  Birimi için <br><br> Stok kodu Sample ID'yu otomatik olarak oluşturmak için boş bırakın.<br><small class='text-muted'>İşletme ayarlarında sku önekini değiştirebilirsiniz.</small>",
    ...
    'sub_sku' => 'Stok Kodu Sample ID isteğe bağlı.<br><br><small> Stok Kodu Sample ID Otomatik olarak oluşturmak için boş bırakın.<small>',
