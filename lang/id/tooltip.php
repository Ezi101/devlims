...
return [
    ...
    */
    ...
    'sku' => "ID produk unik atau Penyimpanan stok satuan <br><br>Biarkan kosong untuk membuat sample id secara otomatis.<br><small class='text-muted'>Anda dapat memodifikasi awalan sample id dalam pengaturan Bisnis.</small>",
    ...
    'sub_sku' => 'Sample ID adalah opsional. <br><br><small>Biarkan kosong untuk membuat Sample ID secara otomatis.<small>',
