    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item">
                    @if ($isDemo)
                        <a class="text-white btn btn-danger btn-sm" href="{{ route('demo', 'exit') }}">
                            <i class=" fa fa-external-link"></i> Exit Demo Mode
                        </a>
                    @else
                        <a class="text-white" href="{{ route('demo', 'try') }}">
                            <i class=" fa fa-external-link"></i> Try Demo Mode
                        </a>
                    @endif
                </li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        @php
                            ...
                            $roleName = ucwords(explode('#', $rawRole)[0]); 
                        @endphp
                        ...
                        <span style="display: block;">
                            ...
                            @if ($roleName)
                                <div
                                    style="background-color: #23467A; color: #F6F6F6; padding: 0px 6px; border-radius: 9px; font-size: 10px; display: inline-block;">
                                    {{ $roleName }}
                                </div>
                            @endif
                        </span>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header" style="background: transparent;">
                            ...
                            @endif
                            {{-- <p style="color: black">
                                {{ Auth::User()->getUserFullNameAttribute() }}
                            </p> --}}
                        </li>
                        <!-- Menu Body -->
                        <!-- Menu Footer-->
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ action([\App\Http\Controllers\UserController::class, 'getProfile']) }}"
                                    class="btn btn-default"><i class="fas fa-user"></i></a>
                            </div>
                            <div class="pull-right">
                                <a href="{{ action([\App\Http\Controllers\Auth\LoginController::class, 'logout']) }}"
                                    class="btn btn-danger"><i class="fa-solid fa-power-off"></i></a>
                            </div>
                        </li>
                    </ul>
                </li>
