...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('lang_v1.str')
            <small>@lang('lang_v1.manage_str_report') ({{ $product->code }})</small>
        </h1>
    </section>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($s->status == 'approved')
                                                            <span
                                                                style="color: green;"><strong>{{ ucfirst($s->status) }}</strong></span>
                                                        @elseif($s->status == 'rejected')
                                                            <span
                                                                style="color: red;"><strong>{{ ucfirst($s->status) }}</strong></span>
                                                        @else
                                                            {{ ucfirst($s->status) }}
                                                        @endif
                                                    </td>
