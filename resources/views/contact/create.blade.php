    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('supplier_business_name', __('contact.supplier_name_label') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                            ...
                            {!! Form::text('supplier_business_name', null, [
                                'class' => 'form-control',
                                'placeholder' => __('contact.supplier_name_placeholder'),
                            ]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('mobile', null, ['class' => 'form-control', 'placeholder' => __('contact.mobile_placeholder')]) !!}
                        </div>
                    </div>
                </div>
