    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            {{-- <div class="form-group">
                ...
                {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __('brand.brand_name_placeholder')]) !!}
            </div> --}}

            <div class="form-group">
                {!! Form::label('name', __('brand.brand_name') . ':*') !!}
                {{-- Isay Text field hi rehne dein taake sahi naam save ho --}}
                {!! Form::text('name', null, [
                    'class' => 'form-control',
                    'required',
                    'placeholder' => __('brand.brand_name_placeholder'),
                ]) !!}
            </div>
