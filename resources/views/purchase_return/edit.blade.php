@extends('layouts.app')
@section('title', __('Edit Sample Return'))
		...
		<div class="box-body">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<table class="table table-bordered table-striped table-condensed table-th-green text-center" 
