                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        {!! Form::text(
                                                            ...
                                                            @format_quantity($qty),
                                                            ['class' => 'form-control input-sm input_number purchase_quantity input_quantity', 'required'],
                                                        ) !!}
                                                    ...
                                                    @if (!empty($product->second_unit))
                                                        ...
                                                        {!! Form::text(
                                                            ...
                                                            ['class' => 'form-control input-sm input_number input_quantity', 'required'],
                                                        ) !!}
                                                    @endif
                                                </td>
                                                <td>
                                                    {!! Form::text(
                                                        ...
                                                        ['class' => 'form-control input-sm input_number unit_price', 'required'],
                                                    ) !!}
                                                </td>
                                                ...
                                                <td>
                                                    <div class="input-group date">
                                                        {!! Form::text(
                                                            'stocks[' . $key . '][' . $variation->id . '][' . $sub_key . '][transaction_date]',
                                                            $transaction_date,
                                                            ['class' => 'form-control input-sm os_date', 'readonly'],
                                                        ) !!}
                                                    </div>
                                                </td>
                                                <td>
