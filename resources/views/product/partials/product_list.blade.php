...
@endphp
<table class="table ajax_view table-striped hide-footer" id="product_table" style="width: 100%;">
    <thead>
        <tr>
            ...
            {{-- @endcan --}}
            {{-- <th style="display: none">@lang('report.current_stock')</th> --}}
            {{-- <th>@lang('product.product_type')</th> --}}
            <th>@lang('product.category')</th>
            <th>@lang('product.sub_category')</th>
            {{-- <th>@lang('product.brand')</th> --}}
            {{-- <th style="display: none">@lang('reagent.reagent')</th> --}}
            {{-- <th>@lang('method.method')</th> --}}
            {{-- <th>@lang('report.current_stock')</th> --}}
            <th>@lang('product.unit')</th>
            <th>@lang('product.ptr')</th>
            {{-- <th>@lang('product.sku')</th> --}}
            {{-- <th>@lang('lang_v1.section')</th> --}}
                ...
                <div style="display: flex; width: 100%;">
                    ...
                    @can('product.update')
                        ...
                        @if (config('constants.enable_product_bulk_edit'))
                            &nbsp;
                            {!! Form::open([
                                'url' => action([\App\Http\Controllers\ProductController::class, 'bulkEdit']),
                                'method' => 'post',
                                'id' => 'bulk_edit_form',
                            ]) !!}
