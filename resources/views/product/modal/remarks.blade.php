...
<div class="modal" id="remarksModal" tabindex="-1" style="overflow: scroll">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ action([\App\Http\Controllers\PTRController::class, 'ptr_approval_store']) }}"
                method="POST">
                @csrf
                <div class="remarkdata">
                    <input type="hidden" name="status" value="rejected">
                    <input type="hidden" name="ptr_no" value="{{ @$ptr->ptr_no }}">
                    <label for="remarks">Remarks</label>
                    <br>
                    <textarea name="remarks_description" id="remarks" cols="30" rows="6"></textarea>
                </div>
