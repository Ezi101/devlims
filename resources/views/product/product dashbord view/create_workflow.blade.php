<div class="modal-dialog  modal-lg" role="document" id="new_workflow">
    {!! Form::open(['action' => '\Modules\Project\Http\Controllers\ProjectController@store', 'id' => 'workflow_form', 'method' => 'post']) !!}
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('product_id', __('product.products') .':*') !!}
                       {!! Form::select('product_id', $samples, null, ['class' => 'form-control select2','readonly' ,'required', 'style' => 'width: 100%;']); !!}
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                   <div class="form-group">
                        {!! Form::label('start_date', __('project::lang.start_date_time') . ':' )!!}
                        {!! Form::text('start_date', '', ['class' => 'form-control datetimepicker', 'readonly']); !!}
                   </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('end_date', __('project::lang.end_date_time') .':') !!}
                        {!! Form::text('end_date', '', ['class' => 'form-control datetimepicker', 'readonly']); !!}
                    </div>
                </div>
            </div>
            <div class="row">
