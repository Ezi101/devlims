            ...
            <td align="center" valign="center">
                <div style="overflow: hidden !important;display: flex; flex-wrap: wrap;align-content: center;width: {{$barcode_details->width * 1}}in; height: {{$barcode_details->height * 1}}in; justify-content: center;">
                    ...
                    <div>
                        ...
                        @if(!empty($print['entry_date']) && !empty($page_product->entry_date))
                            <span style="font-size: {{$print['entry_date_size']}}px">
                                <b>@lang('product.entry_date'):</b>
                                {{$page_product->entry_date}}
                            </span>
                        @endif
                        <br>
                        @if(!empty($print['expiry_date']) && !empty($page_product->expiry_date))
                            <span style="font-size: {{$print['expiry_date_size']}}px">
                                <b>@lang('product.expiry_date'):</b>
