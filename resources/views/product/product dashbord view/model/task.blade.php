<div class="modal-dialog modal-lg" role="document">
    {!! Form::open(['action' => '\Modules\Project\Http\Controllers\TaskController@store', 'id' => 'sample_dashbord_task_form', 'method' => 'post']) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                       ...
                       {!! Form::select('user_id[]', $project_members, null, ['class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;']); !!}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
