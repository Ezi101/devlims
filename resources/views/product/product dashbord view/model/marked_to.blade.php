<div class="modal-dialog modal-lg" role="document">
    {!! Form::open(['action' => '\App\Http\Controllers\MessageboxController@store', 'id' => 'sample_dashbord_marked_form', 'method' => 'post']) !!}
            ...
            <div class="row">
                <div class="col-md-12">
                   <div class="form-group">
                        {!! Form::label('title', __('marked_by.title') . ':*' )!!}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                       ...
                       {!! Form::select('user_id', $project_members, null, ['class' => 'form-control select2','style' => 'width: 100%;']); !!}
                    </div>
                </div>
            </div>
        </div>
