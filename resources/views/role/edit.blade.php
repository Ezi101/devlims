...
@section('content')
                    ...
                    {{-- <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'sample_management.view',
                                    in_array('sample_management.view', $role_permissions),
                                    [
                                        'class' => 'input-icheck',
                                    ],
                                ) !!}
                                {{ __('role.sample_management.view') }}
                            </label>
                        </div>
                    </div> --}}
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('purchase.action_button', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                                {{ __('lang_v1.action_button') }}
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    in_array('purchase.receive_status', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                                {{ __('lang_v1.receive_status') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'purchase.pending_status',
                                    in_array('purchase.pending_status', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                                {{ __('lang_v1.pending_status') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'purchase.ordered_status',
                                    in_array('purchase.ordered_status', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                                {{ __('lang_v1.ordered_status') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'issue_status_view', in_array('issue_status_view', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                                {!! __('lang_v1.issue_status_view') !!}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'purchase.save_draft', in_array('purchase.save_draft', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                                {!! __('lang_v1.savedraft') !!}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'purchase.forward_to_afmsl',
                                    in_array('purchase.forward_to_afmsl', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                                {!! __('lang_v1.forwardtoafmsl') !!}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'purchase.recevied_by_afmsl',
                                    in_array('purchase.recevied_by_afmsl', $role_permissions),
                                    ['class' => 'input-icheck'],
                                ) !!}
                                {!! __('lang_v1.receviedbyafmsl') !!}
                            </label>
                        </div>
                    </div>
    ...
    @endif --}}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'issue.table_colums', in_array('issue.table_colums', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.issue.table_colums') }}
                            </label>
                        </div>
                    </div>
                    {{-- <div class="col-md-12">
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-7">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio('radio_option[sell_view]', 'sell.view', in_array('sell.view', $role_permissions), [
                                        'class' => 'input-icheck',
                                    ]) !!} {{ __('lang_v1.view_all_sell') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio('radio_option[sell_view]', 'sell.view_own', in_array('sell.view_own', $role_permissions), [
                                        'class' => 'input-icheck',
                                    ]) !!} {{ __('lang_v1.view_own_sell') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::radio(
                                    'radio_option[quotation_view]',
                                    'view_own.quotation',
                                    in_array('view_own.quotation', $role_permissions),
                                    ['class' => 'input-icheck'],
    ...
    @endif --}}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'sample_report.view', in_array('sample_report.view', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.sample_report.view') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'detail_report.view', in_array('detail_report.view', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!} {{ __('lang_v1.detail_report.view') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-7">
                    ...
                    {{-- <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'package_subscription', in_array('package_subscription', $role_permissions), [
                                    'class' => 'input-icheck',
                                ]) !!}
                                {{ __('lang_v1.package_subscription') }}
                            </label>
                        </div>
                    </div> --}}
                </div>
    ...
    @endif --}}
            @foreach ($created_permissions as $group)
                <hr>
                <div class="row check_group">
                    <div class="col-md-3">
                        <h4>@lang('role.' . $group->permission_group)</h4>
                    </div>
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label>
                    ...
                    <div class="col-md-7">
                        @foreach (explode(',', $group->permissions_in_group) as $permission)
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', $permission, in_array($permission, $role_permissions), [
                                            'class' => 'input-icheck',
                                        ]) !!}
