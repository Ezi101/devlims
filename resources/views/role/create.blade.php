                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio('radio_option[so_view]', 'sell.view', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_all_so') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio('radio_option[so_view]', 'sell.view_own', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_own_so') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                  ...
                  <div class="col-md-7">
                      @foreach (explode(',', $group->permissions_in_group) as $permission)
                          <div class="col-md-12">
                              <div class="checkbox">
                                  <label>
                                      {!! Form::checkbox('permissions[]', $permission, false, ['class' => 'input-icheck']) !!} {{$permission}}
                                  </label>
                              </div>
                          </div>
                      @endforeach
