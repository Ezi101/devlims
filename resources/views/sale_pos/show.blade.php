<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> @lang('sale.issue_detail') (<b>@if($sell->type == 'sales_order') @lang('restaurant.order_no') @else @lang('sale.invoice_no') @endif :</b> {{ $sell->invoice_no }})
    </h4>
</div>
<div class="modal-body">
    ...
    <div class="row">
      ...
      <b>{{ __('sale.customer_name') }}:</b> {{ $sell->issueTo->first_name  ?? '--'}} {{ $sell->issueTo->last_name  ?? '--'}}<br>
      <div class="@if(!empty($export_custom_fields)) col-sm-3 @else col-sm-4 @endif">
