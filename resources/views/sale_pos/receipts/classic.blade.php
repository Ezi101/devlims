...
<div class="row" style="color: #000000 !important;">
    @if (empty($receipt_details->letter_head))
        ...
        <div class="col-xs-12" style=" display: flex;  justify-content: space-between;">
            <img style="max-height: 100px; width: auto;" src="{{ asset('dummy/paklogo4.png') }}"
                class="img img-responsive ">
            <h5 style="align-items: center; margin-top: 50px"><strong>ARMED FORCES MEDICAL STORES LABORATORY</strong>
            </h5>
            <img style="max-height: 100px; width: auto;" src="{{ asset('dummy/AFMS LOGO-01.png') }}"
                class="img img-responsive ">
        </div>
        {{-- @endif --}}
        ...
        <p style="width: 100% !important" class="word-wrap">
            <span class="pull-left text-left word-wrap">
                ...
                @if (!empty($receipt_details->customer_info))
                    <br />
                    <b>User: {{ $receipt_details->customer_name }}</b> <br>
                    <b>Role: {{ $role_name }}</b> <br> <br>
                @endif
