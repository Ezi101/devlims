@extends('layouts.app')
@section('title', __('formula.edit_formula'))
<style>
    #ab{
...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('formula.edit_formula')</h1>
    </section>

    <!-- Main content -->
    <section class="content">
        {!! Form::open([
            'url' => action([\App\Http\Controllers\FormulasController::class, 'update'],['formula' => $formula->id]),
            'method' => 'put',
            'id' => 'formula',
        ]) !!}
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('formula_id',$formula->formula_id, [
                            'class' => 'form-control',
                            'readonly',
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('description', $formula->description, ['class' => 'form-control', 'placeholder' => __('brand.short_description')]) !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        @endphp
                        {!! Form::select('status', $item_types, !empty($formula->status) ? $formula->status : null, [
                            ...
                            <table class="table table-bordered table-striped ajax_view hide-footer" id="data-table">
                                ...
                                <tbody>
                                    @foreach ($group as $g)
                                        <tr>
                                            <td>
                                                <input type="button" value="Select" class="select-button btn-primary" data-name="{{ $g->name }}">
                                            </td>
                                            <td>{{ $g->name }}</td>
                                            <td>{{ $g->description }}</td>
                                        </tr>
                            ...
                            <div class="tab-pane active" id="ab">
                                <table class="table table-bordered table-striped ajax_view hide-footer">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input type="button" value="SQR" class="select-button btn-primary" data-name="SQR">
                                            </td>
                                            <td>Square Root</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="button" value="LOG" class="select-button btn-primary" data-name="LOG">
                                            </td>
                                            <td>Logarithim</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="button" value="EXP" class="select-button btn-primary" data-name="EXP">
                                            </td>
                                            <td>Anitlogarithim</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="button" value="ABS" class="select-button btn-primary" data-name="ABS">
                                            </td>
                                            <td>Absolute</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="button" value="COS" class="select-button btn-primary" data-name="COS">
                                            </td>
                                            <td>Cosine</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="button" value="Sin" class="select-button btn-primary" data-name="Sin">
                                            </td>
                                            <td>Sin</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="button" value="Tan" class="select-button btn-primary" data-name="Tan">
                                            </td>
                                            <td>Tangent</td>
                                        </tr>
                                    </tbody>
