                ...
                <table class="table table-striped ajax_view" id="sell_table" style="width: 100%">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('sale.po_number')</th>
                            <th>@lang('sale.months')</th>

                            {{-- <th>@lang('batch.b_no')</th>
                            <th>@lang('batch.b_mfg_date')</th>
                            <th>@lang('batch.b_expiry_date')</th> --}}
        ...
        $(document).ready(function() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                columns: [{
                    ...
                    //     name: 'purchase_ref_no', // Isay alias hi rehne dein
                    //     orderable: false,
                    //     searchable: false,  
                    //     render: function(data, type, row) {
                    //         // Workflow screen wala PO (PO2026/6816) yahan display hoga
                    //         return data ? data : row.invoice_no;
                    //     }
                    // },
                    {
                        data: 'purchase_ref_no',
                        name: 'purchase_ref_no',
                        searchable: true, // ✅ false se true
                        render: function(data, type, row) {
                            if (data) return data;
                            if (row.transaction_backup_po) return row.transaction_backup_po;
