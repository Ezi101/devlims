                ...
                @component('components.widget', ['class' => 'box-solid'])
                            ...
                            <div class="input-group">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-default bg-white btn-flat" data-toggle="modal"
                                        data-target="#configure_search_modals"
                    ...
                    @if (count($business_locations) > 0)
                        ...
                        <div class="@if (!empty($commission_agent)) col-sm-3 @else col-sm-3 @endif">
                            <div class="form-group">
                                {!! Form::label('product_locations', __('lang_v1.product_locations') . ':*') !!}
                                <div class="input-group">
                                    <span class="input-group-addon">
                    ...
                    {{-- <div class="@if (!empty($commission_agent)) col-sm-3 @else col-sm-3 @endif">
                        <div class="form-group">
                            {!! Form::label('contact_id', __('user.users') . ':*') !!}
                            <div class="input-group">
                                <span class="input-group-addon">
                ...
                <small class="text-danger hide contact_due_text"><strong>@lang('account.customer_due'):</strong>
                    ...
                    {{-- <div class="col-sm-3">
                        <div class="form-group">
                           ...
                           @show_tooltip(__('lang_v1.documents_help_text'))
                ...
                @component('components.widget', ['class' => 'box-solid'])
                    <div class="row col-sm-12 pos_product_div" style="min-height: 0">
                        ...
                        <div class="table-responsive">
                            ...
                            {{-- OLd Code OF ISSUE SAMPLES --}}
                            {{-- <table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table" style="">
                                <thead>
                                    <tr>
                            ...
                            {{-- COUSTOME CODE AS PER THS SIR INSTRUCTION TO ISSUE SAMPLES --}}

                            <div class="information_div" id="information_div_id"></div>
