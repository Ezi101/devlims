...
<section class="content">
  ...
  <div class="row">
      <div class="col-md-12">
          @component('components.widget', ['class' => 'box-primary', 'id' => 'user_fields'])
              <div class="col-md-2">
                  <div class="form-group">
                      {!! Form::label('surname', __( 'business.prefix' ) . ':') !!}
                      {!! Form::text('surname', $user->surname, ['class' => 'form-control', 'placeholder' => __( 'business.prefix_placeholder' ), 'readonly' => $auth_user_role != 'Admin#15']) !!}
                  </div>
              </div>
              <div class="col-md-5">
                  <div class="form-group">
                      {!! Form::label('first_name', __( 'business.first_name' ) . ':*') !!}
                      {!! Form::text('first_name', $user->first_name, ['class' => 'form-control', 'required', 'placeholder' => __( 'business.first_name' ), 'readonly' => $auth_user_role != 'Admin#15']) !!}
                  </div>
              </div>
              <div class="col-md-5">
                  <div class="form-group">
                      {!! Form::label('last_name', __( 'business.last_name' ) . ':') !!}
                      {!! Form::text('last_name', $user->last_name, ['class' => 'form-control', 'placeholder' => __( 'business.last_name' ), 'readonly' => $auth_user_role != 'Admin#15']) !!}
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                      ...
                      {!! Form::text('email', $user->email, ['class' => 'form-control', 'required', 'placeholder' => __( 'business.email' ), 'readonly' => $auth_user_role != 'Admin#15']) !!}
                  </div>
              </div>
                          ...
                          <div class="form-group">
                              ...
                              @if(!empty($username_ext))
                                  <div class="input-group">
                                      {!! Form::text('username', $user->username, ['class' => 'form-control', 'placeholder' => __( 'business.username' ), 'readonly' => $auth_user_role != 'Admin#15']) !!}
