@extends('layouts.app')
@section('title', __('sale.issue_reagent'))


@section('content')
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>@lang('sale.issue_reagent')</h1>
    </section>
    <!-- Main content -->
    <section class="content no-print">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\SellPosController::class, 'reagent_store']),
            'method' => 'post',
            'id' => 'add_sell_form',
            'files' => true,
        ]) !!}
                ...
                @component('components.widget', ['class' => 'box-primary'])
                    ...
                    @if (count($business_locations) > 0)
                        ...
                        <div class="@if (!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                            <div class="form-group">
                                {!! Form::label('product_locations', __('lang_v1.reagent_locations') . ':*') !!}
                                <div class="input-group">
                                    <span class="input-group-addon">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                {!! Form::text('search_product', null, [
                                    'class' => 'form-control mousetrap',
                                    'id' => 'search_product',
                                    'placeholder' => __('lang_v1.search_reagent_placeholder'),
...
@section('javascript')
    <script src="{{ asset('js/reagent_issue.js?v=' . $asset_v) }}"></script>
