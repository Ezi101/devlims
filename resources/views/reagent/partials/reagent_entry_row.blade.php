@foreach ($variations as $variation)
    <tr @if (!empty($purchase_order_line)) data-purchase_order_id="{{ $purchase_order_line->transaction_id }}" @endif
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <button type="button" class="btn btn-default bg-white btn-flat btn-modal"
                        data-href="{{ action([\App\Http\Controllers\BatchController::class, 'createLotNo'], ['quick_add' => true, 'product_id' => $product->id]) }}"
        ...
        {{-- @if (empty($is_purchase_order)) --}}
            ...
            {{-- CAS No --}}
            <td>
                {!! Form::text('purchases[' . $row_count . '][cas_no]', $exp_date, [
                    'class' => 'form-control input-sm cas_no',
                    'id' => 'cas_no'
                ]) !!}
            </td>
            <td>
