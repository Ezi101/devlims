...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('reagent.reagent')
            <small>@lang('lang_v1.manage_reagents')</small>
        </h1>
        @can('Re-agents.create')
            <a class="btn btn-primary pull-right" href="{{ action([\App\Http\Controllers\ReagentController::class, 'create']) }}">
                    ...
                    @endcan
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active">
                                {{-- @if ($is_admin)
                            <a class="btn btn-success pull-right margin-left-10" href="{{action([\App\Http\Controllers\ProductController::class, 'downloadExcel'])}}"><i class="fa fa-download"></i> @lang('lang_v1.excel')</a>
                        @endif --}}

                                @include('reagent.partials.reagent_list')
                            </div>
                            {{-- @can('stock_report.view')
        ...
        $(document).ready(function() {
            product_table = $('#product_table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'batch_no',
                        name: 'products.batch_no'
                    },
                    {
                        data: 'entry_date',
                        name: 'products.entry_date'
                    },
                    {
                        data: 'expiry_date',
                        name: 'products.expiry_date'
                    },
                    {
                        data: 'item_type',
