@extends('layouts.app')
@section('title', __('method.reading_test'))

@section('content')

    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>@lang('method.reading_test')</h1>
        <!-- <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('formula', __('method.select_formula') . ':*') !!}
                        <div class="input-group">
                            {!! Form::select('formula', ['' => 'Select formula'] + $formula, null, [
                                'class' => 'form-control select2 groupall',
                                'required',
