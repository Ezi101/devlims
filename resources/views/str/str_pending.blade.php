@extends('layouts.app')
@section('title', __('Pending STRs'))

@section('content')

    <section class="content-header">
        <h1>@lang('lang_v1.str')
            <small>@lang('lang_v1.manage_pending_str_report')</small>
        </h1>
    </section>
    ...
    <section class="content">
            <div class="box-body">
                ...
                @include('str.partials.strs_table', ['strs' => $pendingStrs])
            </div>
    </section>
    <style>
...
@section('javascript')
    ...
    // Call the function to bind the click event when the page loads
    bindRowClick();
