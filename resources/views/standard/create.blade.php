...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('reagent.add_standard')</h1>
    </section>
    ...
    <section class="content">
        ...
        @endphp
        {!! Form::open([
            'url' => action([\App\Http\Controllers\StandardController::class, 'store']),
            'method' => 'post',
            'id' => 'product_add_form',
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('name', __('reagent.standard_name') . ':*') !!}
                        {!! Form::text('name', !empty($duplicate_product->name) ? $duplicate_product->name : null, [
                            'class' => 'form-control',
                            'required',
                            'placeholder' => __('reagent.standard_name'),
                        ]) !!}
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('sku', __('reagent.s_sku') . ':') !!}
                        {!! Form::text('sku', null, ['class' => 'form-control', 'placeholder' => __('reagent.s_sku')]) !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
        ...
        @endif --}}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('types_of_sample', __('reagent.standard_type') . ':') !!}
                        @php
                            $type_of_Samples = [
                                '' => 'Please Select',
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('image', __('reagent.standard_image') . ':') !!}
                        {!! Form::file('image', [
                            'id' => 'upload_image',
                            'accept' => 'image/*',
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    {!! Form::label('product_brochure', __('reagent.standard_brochure') . ':') !!}
