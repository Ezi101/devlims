...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('reagent.standard')
            <small>@lang('lang_v1.manage_stnadard')</small>
        </h1>
        @can('Standard.create')
            <a class="btn btn-primary pull-right"
                href="{{ action([\App\Http\Controllers\StandardController::class, 'create']) }}">
                ...
                <div class="col-md-12">
                    ...
                    @endcan
                        ...
                        @endif --}}
                                ...
                                @include('standard.partials.standard_list')
                            </div>
                            {{-- @can('stock_report.view')
