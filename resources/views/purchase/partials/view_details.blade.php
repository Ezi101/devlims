            ...
            <div style="margin-top: -45px">
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-3 invoice-col">
                        ...
                        <b>@lang('purchase.nature'):</b> {{ strtoupper($purchase->contract_type) }} -
                        @if ($purchase->contract_type === 'lp')
                            {{ $purchase->source_name }}
                        @endif
                        @php
                            $first_line = $purchase->purchase_lines->first();
                        @endphp

                        @if (!empty($first_line->contract))
                            {{ $first_line->contract->number }}
                        @endif
                    </div>
