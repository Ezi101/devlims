        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="tests-navbar-collapse">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('purchase.view') ? 'active' : '' }}"
                            href="{{ route('purchase.view') }}">
                            <i class="fa-solid fa-circle-chevron-down"></i>
                            <span>@lang('purchase.received')</span> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('received-stock.indexnew') ? 'active' : '' }}"
                            href="{{ route('received-stock.indexnew') }}">
                            <i class="fa-solid fa-share-from-square"></i>
                            <span>@lang('purchase.issued_samples')</span> </a>
                    </li>
                </ul>
            </div>
