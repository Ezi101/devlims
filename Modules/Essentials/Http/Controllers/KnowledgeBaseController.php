...
class KnowledgeBaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            AuditLogger::log('created', 'KB', 'KB ID: ' . $kb->id);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            AuditLogger::log('updated', 'KB', 'KB ID: ' . $kb->id.' was <b>updated</b>');
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try {
            $kb = KnowledgeBase::where('business_id', $business_id)
                ->where('id', $id)
                ->firstOrFail(); // Retrieve the KnowledgeBase instance

            AuditLogger::log('deleted', 'KB', 'KB ID: ' . $kb->id);
            $kb->delete();
