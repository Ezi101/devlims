...
Route::middleware('web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('project')->group(function () {
    ...
    Route::get('project/test/issue', [Modules\Project\Http\Controllers\TaskController::class, 'issue_test']);
    Route::post('project/test/issue/store', [Modules\Project\Http\Controllers\TaskController::class, 'issue_test_store']);
