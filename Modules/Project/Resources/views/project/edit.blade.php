            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                       ...
                       {!! Form::select('product_id', $samples, $project->product_id, ['class' => 'form-control select2', 'required', 'style' => 'width: 100%;']); !!}
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                   <div class="form-group">
                        ...
                        {!! Form::text('start_date', !empty($project->start_date) ? @format_datetime($project->start_date) : '', ['class' => 'form-control datetimepicker', 'readonly']); !!}
                   </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('end_date', __('project::lang.end_date_time') .':') !!}
                        {!! Form::text('end_date', !empty($project->end_date) ? @format_datetime($project->end_date) : '', ['class' => 'form-control datetimepicker', 'readonly']); !!}
                    </div>
                </div>
            </div>
            <div class="row">
