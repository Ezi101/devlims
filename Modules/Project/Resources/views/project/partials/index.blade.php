                    ...
                    <tbody>
                        @foreach ($projects as $project)
                            <tr>
                                ...
                                {{ $project->product->name }} ({{ $project->product->generic ? $project->product->generic->name : '' }})
                                     @else -
                                     @endif</td>
                                <td>@if (isset($project->product->name))
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle btn-sm btn-default" type="button"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="action">
                                            <li>
                                                <a
                                                    href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], [$project->id]) }}">
                                            ...
                                            @can('workflow.edit_project')
                                                <li>
                                                    <a data-href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'edit'], [$project->id]) }}"
                                                        class="cursor-pointer edit_a_project">
                                            ...
                                            @can('workflow.delete_project')
                                                <li>
                                                    <a data-href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'destroy'], [$project->id]) }}"
                                                        class="cursor-pointer delete_a_project">
                                            ...
                                            <li>
                                                <a
                                                    href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], [$project->id]) . '?view=overview' }}">
                                            ...
                                            <li>
                                                <a
                                                    href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], [$project->id]) . '?view=activities' }}">
                                            ...
                                            <li>
                                                <a
                                                    href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], [$project->id]) . '?view=project_task' }}">
                                            ...
                                            @if (isset($project->settings['enable_timelog']) && $project->settings['enable_timelog'])
                                                <li>
                                                    <a
                                                        href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], [$project->id]) . '?view=time_log' }}">
                                            ...
                                            @if (isset($project->settings['enable_notes_documents']) && $project->settings['enable_notes_documents'])
                                                <li>
                                                    <a
                                                        href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], [$project->id]) . '?view=documents_and_notes' }}">
                                            ...
                                            @if (isset($project->settings['enable_invoice']) && $project->settings['enable_invoice'] && $project->is_lead_or_admin)
                                                <li>
                                                    <a
                                                        href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], [$project->id]) . '?view=project_invoices' }}">
                                            ...
                                            @if ($project->is_lead_or_admin)
                                                <li>
                                                    <a
                                                        href="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], [$project->id]) . '?view=project_settings' }}">
                ...
                <div class="box box-solid box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle btn-sm btn-default" type="button" id="action"
